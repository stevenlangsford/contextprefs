...
ggsave(ggplot(calcplot.df,aes(x=calcsd,y=meanreturn,color=modeltype))+geom_point()+geom_line()+theme_bw(),
       file="varycalc.png")
...
ggsave(ggplot(ordplot.df,aes(x=orderror,y=meanreturn,color=modeltype))+geom_point()+geom_line()+theme_bw(),
       file="varyord.png")
