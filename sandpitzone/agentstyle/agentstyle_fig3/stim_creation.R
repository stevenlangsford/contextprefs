...
if(!exists("hm_ppnts"))stop("Sourced stim_creation without hm_ppnt inits set") 
if(!exists("ppnt_calcsd"))stop("Sourced stim_creation without ppnt_calcsd inits set")
if(!exists("ppnt_tolerance_prob"))stop("Sourced stim_creation without ppnt_tolerance_prob inits set")
if(!exists("ppnt_tolerance_payoff"))stop("Sourced stim_creation without ppnt_tolerance_payoff inits set")
if(!exists("ppnt_orderror"))stop("Sourced stim_creation without ppnt_orderror inits set")
if(!exists("useord"))stop("Sourced stim_creation without ppnt useord inits set")
if(!exists("usecalc"))stop("Sourced stim_creation without ppnt usecalc inits set")
