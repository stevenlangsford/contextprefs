...
stim.df <- data.frame(
    ...
    attributeA_option1=runif(hm_trials,0,1),
    attributeA_option2=runif(hm_trials,0,1),
    attributeB_option1=runif(hm_trials,0,1),
    attributeB_option2=runif(hm_trials,0,1),
