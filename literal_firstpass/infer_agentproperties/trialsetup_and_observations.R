...
for(i in 1:hm_ppnts){
    for(j in 1:hm_trials){
        ...
        impressions.df[impression.row,"ppnt_calcsd"]=ppnt_calcsd[i];
        impressions.df[impression.row,"ppnt_tolerance_prob"]=ppnt_tolerance_prob[i];
        impressions.df[impression.row,"ppnt_tolerance_payoff"]=ppnt_tolerance_payoff[i];
        impressions.df[impression.row,"ppnt_p_err"]=ppnt_p_err[i];
